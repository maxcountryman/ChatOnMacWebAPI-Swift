...
// We reverted the change of ChatOnMacWebAPI to ChatOnMacWeb introduced in https://github.com/OpenAPITools/openapi-generator/pull/9624
...
@available(*, deprecated, renamed: "ChatOnMacWebAPI")
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool) {
        ...
        addHeaders(ChatOnMacWebAPI.customHeaders)
    }
    ...
    @discardableResult
    open func execute(_ apiResponseQueue: DispatchQueue = ChatOnMacWebAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
    ...
    open func addCredential() -> Self {
        credential = ChatOnMacWebAPI.credential
        return self
    }
}
